define([
	...
	'./has',
	'./patch!'
], function (require, app, on, Deferred, winUtils, put) {
	app.startup = function (/*Object*/ config) {
		//	summary:
		...
		(config.require || require)([ config.moduleId ], function (Ui) {
			...
			put(winUtils.body(), app.ui.domNode);
			app.ui.init(config).then(dfd.resolve, dfd.reject);
		});

		return dfd.promise;

		// TODO: The following needs to be abstracted out to ./ui/Mobile.js
