...
declare module 'intern/dojo/node!leadfoot/helpers/pollUntil' {
	var pollUntil:{
		(poller:Function, args?:any[], timeout?:number, pollInterval?:number):IPromise<any>;
		(poller:string, args?:any[], timeout?:number, pollInterval?:number):IPromise<any>;
	};
	export = pollUntil;
}
