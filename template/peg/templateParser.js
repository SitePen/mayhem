  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "DataBindingExpression": parse_DataBindingExpression,
        "FunctionCall": parse_FunctionCall,
        "FunctionArgument": parse_FunctionArgument,
        ...
        "WidgetProperty": parse_WidgetProperty,
        "WidgetPropertyList": parse_WidgetPropertyList,
        "S": parse_S
      };
      ...
      function parse_DataBindingExpression() {
        var result0;
      ...
      function parse_FunctionCall() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              result3 = parse_FunctionArgument();
              result3 = result3 !== null ? result3 : "";
              if (result3 !== null) {
                result4 = [];
                pos2 = clone(pos);
                ...
                if (result5 !== null) {
                  result6 = parse_FunctionArgument();
                  if (result6 !== null) {
                ...
                if (result5 !== null) {
                  result5 = (function(offset, line, column, arg) { return arg; })(pos2.offset, pos2.line, pos2.column, result5[1]);
                }
                if (result5 === null) {
                  pos = clone(pos2);
                }
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, functionIdentifier, leadingArgument, trailingArguments) {
      ...
      function parse_FunctionArgument() {
        var result0;
      ...
      function parse_WidgetProperty() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              result3 = parse_DataBindingExpression();
              if (result3 !== null) {
                result0 = [result0, result1, result2, result3];
              } else {
                result0 = null;
      ...
      function parse_WidgetPropertyList() {
        var result0, result1, result2, result3, result4, result5;
        var pos0, pos1, pos2, pos3;
        
        pos0 = clone(pos);
        pos1 = clone(pos);
        result0 = parse_WidgetProperty();
        result0 = result0 !== null ? result0 : "";
        if (result0 !== null) {
          result1 = [];
          pos2 = clone(pos);
          ...
          if (result2 !== null) {
            result2 = (function(offset, line, column, property) { return property; })(pos2.offset, pos2.line, pos2.column, result2[3]);
          }
          if (result2 === null) {
            pos = clone(pos2);
          }
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, firstProperty, remainingProperties) {
        		if (firstProperty) {
