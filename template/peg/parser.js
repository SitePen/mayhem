  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "ConditionalVariable": parse_ConditionalVariable,
        ...
        "RegExp": parse_RegExp,
        "Object": parse_Object,
        "ObjectLiteralList": parse_ObjectLiteralList,
        "ObjectLiteralItem": parse_ObjectLiteralItem,
        "Array": parse_Array,
      ...
      function parse_AliasBlock() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, aliases) {
        		return {
        			type: 'alias',
        			aliases: aliases
        		};
      ...
      function parse_Aliases() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, firstAlias, rest) {
      ...
      function parse_Variable() {
        ...
        result0 = parse_ConditionalVariable();
        if (result0 === null) {
      ...
      function parse_ConditionalVariable() {
        var result0, result1, result2, result3, result4;
        var pos0, pos1;
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, condition, value) {
        		return {
      ...
      function parse_RegExp() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, regExp) {
      ...
      function parse_Object() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            result2 = parse_ObjectLiteralList();
            result2 = result2 !== null ? result2 : "";
            if (result2 !== null) {
              result3 = [];
              result4 = parse_S();
      ...
      function parse_ObjectLiteralList() {
        var result0, result1, result2, result3, result4, result5;
        var pos0, pos1, pos2;
        
        pos0 = clone(pos);
        pos1 = clone(pos);
        result0 = parse_ObjectLiteralItem();
        if (result0 !== null) {
          result1 = [];
          pos2 = clone(pos);
          result2 = [];
          ...
          if (result2 !== null) {
            ...
            if (result3 !== null) {
              ...
              if (result4 !== null) {
                result5 = parse_ObjectLiteralItem();
                if (result5 !== null) {
                  result2 = [result2, result3, result4, result5];
                } else {
                  result2 = null;
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, item, rest) {
        		var items = [ item ];
        		for (var i = 0; i < rest.length; ++i) {
        			items.push(rest[i][3]);
        		}
      ...
      function parse_ObjectLiteralItem() {
        var result0, result1, result2, result3, result4;
        var pos0, pos1;
