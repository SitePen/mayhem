  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_HtmlFragment() {
        ...
        if (result1 !== null) {
          result1 = (function(offset, character) { return character; })(pos1, result1[1]);
        }
        if (result1 === null) {
          pos = pos1;
        }
      ...
      function parse_IfTag() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result3 !== null) {
              result3 = (function(offset, elseIfNode, content) {
            			elseIfNode.content = content;
            			return elseIfNode;
            		})(pos2, result3[0], result3[1]);
            }
            if (result3 === null) {
              pos = pos2;
            }
            ...
            if (result2 !== null) {
              ...
              if (result3 !== null) {
                result3 = (function(offset, content) { return content; })(pos2, result3[1]);
              }
              if (result3 === null) {
                pos = pos2;
              }
        ...
        if (result0 !== null) {
          result0 = (function(offset, ifNode, content, elseIfNodes, elseContent) {
      ...
      function parse_IfTagOpen() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, attributes) {
      ...
      function parse_ForTag() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, forNode, content) {
      ...
      function parse_WhenTag() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              result2 = (function(offset, content) { return content; })(pos2, result2[1]);
            }
            if (result2 === null) {
              pos = pos2;
            }
        ...
        if (result0 !== null) {
          result0 = (function(offset, whenNode, resolvedContent, errorContent, progressContent) {
      ...
      function parse_WhenProgressTag() {
        ...
        if (input.substr(pos, 10) === "<progress>") {
          result0 = "<progress>";
          pos += 10;
        } else {
          result0 = null;
      ...
      function parse_PlaceholderTag() {
        ...
        pos0 = pos;
        pos1 = pos;
        if (input.substr(pos, 12) === "<placeholder") {
          result0 = "<placeholder";
          pos += 12;
        } else {
          result0 = null;
      ...
      function parse_Attributes() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, attributes) { return attributes; })(pos0, result0[0]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_Attribute() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              result2 = (function(offset, value) { return value; })(pos2, result2[3]);
            }
            if (result2 === null) {
              pos = pos2;
            }
      ...
      function parse_AttributeName() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, nameChars) { return nameChars.join(''); })(pos0, result0);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_AttributeValue() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, value) { return value.join(''); })(pos0, result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
