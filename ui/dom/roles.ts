...
CheckboxPress.prototype.triggers = Press.prototype.triggers.concat([ keys.press('ENTER') ]);
...
ButtonPress.prototype.triggers = CheckboxPress.prototype.triggers.concat([ keys.press('SPACE') ]);
...
export class DialogOpen extends Action {
	invoke(widget:dom.IElementWidget):void {
...
export var button = { press: new ButtonPress() };

export var checkbox = { press: new CheckboxPress() };

export var dialog = { dismiss: new DialogDismiss(), open: new DialogOpen() };

export var radio = { press: new RadioPress() };
